...
describe("Основи на маршрутизатора", () => {
  ...
  it(
    ...
    () => {
      ...
      fetchPackages.mockImplementation(() => [
        ...
        "TownB,PR_NAME4,TownC,20",
        "TownC,PR_NAME5,TownD,1",
      ]);
  ...
  it(
    ...
    () => {
      ...
      fetchPackages.mockImplementation(() => [
        ...
        "TownC,PR_NAME4,TownA,10",
        "TownD,PR_NAME5,TownA,1",
        "TownA,PR_NAME6,TownD,1",
      ]);
  ...
  //     const fetchPackages = jest.spyOn(dataProvider, "fetchPackages");
  //     fetchPackages.mockImplementation(() => [
  //       "TownA,Product1,TownB,1",
  //       "TownB,Product2,TownC,1",
  //       "TownB,Product3,TownA,1",
  //       "TownC,Product4,TownD,1",
  //       "TownC,Product5,TownA,1",
  //       "TownD,Product6,TownE,1",
  //       "TownD,Product7,TownA,1",
  //       "TownE,Product8,TownF,1",
  //       "TownE,Product9,TownA,1",
  //     ]);
